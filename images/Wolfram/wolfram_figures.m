...
Export["images/Wolfram/cubic.pdf", ContourPlot[(eqn[x,y]==0) // Evaluate,{x,-2.4,2.4},{y,-3.5,3.5},AspectRatio->1,MaxRecursion->6,Axes->False,FrameStyle->White]]
Clear[eqn]

(*parametrized_cusp*)
eqn[x_,y_] := x^3-y^2;
Export["images/Wolfram/parametrized_cusp.pdf", ContourPlot[eqn[x,y]==0,{x,-1,1},{y,-1,1},Axes->False,FrameStyle->White,ImageSize->Full]]
Clear[eqn]
...
(*trott_curve, trott_curve_tangents*)
eqn:=12^2(x^4+y^4)-15^2(x^2+y^2)+350x^2y^2+81;
Export["images/Wolfram/trott_curve.pdf", ContourPlot[eqn\[Equal]0,{x,-1,1},{y,-1,1},ContourStyle->Red,ImageSize->200, Frame->False]]
Export["images/Wolfram/trott_curve_tangents.pdf", ContourPlot[{eqn\[Equal]0,x+0.445,y-0.708,y==x+1.21},{x,-1,1},{y,-1,1},ContourStyle->{Red,Orange,Green,Blue},ImageSize->200, Frame->False]]
Clear[eqn]
